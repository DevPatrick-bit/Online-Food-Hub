...
namespace OnlineFoodHub.Controllers
{
    public class ProductosController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Codigo,Nombre,Tipo,Descripcion,Precio,Imagen,CategoriaID,Stock,Marca,Activo"
            )]
                Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoId,Codigo,Nombre,Tipo,Descripcion,Precio,Imagen,CategoriaID,Stock,Marca,Activo")] Producto producto)
        {
